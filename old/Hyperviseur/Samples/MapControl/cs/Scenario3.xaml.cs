...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario3 : Page
    {
        ...
        private void addXamlChildrenButton2_Click(object sender, RoutedEventArgs e)
        {
            BasicGeoposition center = myMap.Center.Position;
            var pinUri = new Uri("ms-appx:///Assets/MapPin.png");
            MapItems.ItemsSource = new List<PointOfInterest>()
        ...
        private void SetDefaultElementCombobox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
