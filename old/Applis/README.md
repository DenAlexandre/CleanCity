...
Sinon, créez manuellement une base PostgreSQL (ex: `cleancity`), puis dans `server/` :
...
Ouvrez `CleanCity.code-workspace` (double-clic, ou `code CleanCity.code-workspace`), puis dans l'onglet **Run and Debug** (Ctrl+Shift+D) :
